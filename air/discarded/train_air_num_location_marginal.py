...
from air.air_prior_num_location_marginal import AIRModel
...
parser.add_argument("-gn", "-gamma_number", "--gamma_number", type=float, default=1)
...
with tf.Session(config=config) as sess:
    ...
    tmp = sess.run(
        test_model.z_pres_probs_margin,
