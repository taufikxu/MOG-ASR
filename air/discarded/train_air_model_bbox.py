...
from air.air_prior_scale_fixed import AIRModel
...
parser.add_argument(
    ...
    default=1,
    help=
    "mutiply a coefficient to these targeted number of digits, no matter hard or soft",
)
parser.add_argument(
            ...
            if step % LOG_EACH_ITERATION == 0:
                ...
                log.info(
                    "iteration {}\ttrain loss {:.3f}\ttrain accuracy {:.2f}".format(
                        step, l0, a0))
                log.info("iteration {}\ttest loss {:.3f}\ttest accuracy {:.2f}".format(
                    step, l1, a1))
